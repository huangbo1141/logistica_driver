...
- (instancetype) initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backgroundColor = [UIColor clearColor];
        self.backgroundView.backgroundColor = [CGlobal colorWithHexString:@"000000" Alpha:0.1];
    }
    return self;
}
...
- (void) setEnableShadow:(BOOL)enableShadow
{
    ...
    if (enableShadow) {
        ...
        self.containerView.layer.shadowColor = [CGlobal colorWithHexString:@"000000" Alpha:0.1].CGColor;
